...
/** Preset values */
if( defined('IBLOCK_TYPE__CATALOG') )
    $arCurrentValues["IBLOCK_TYPE"] = IBLOCK_TYPE__CATALOG;

$arCurrentValues["SEF_MODE"] = "Y";
$arCurrentValues["SEF_URL_TEMPLATES"] = array("sections", "section", "element", "compare", "smart_filter");
$arCurrentValues["SEF_URL_TEMPLATES"] = array_flip( $arCurrentValues["SEF_URL_TEMPLATES"] );
/** /Preset values */
...
/**
 * Get attached IBlock's properties
 */
...
foreach ($codes as $code => $codeval) {
    unset($arComponentParameters['PARAMETERS'][ $code ]);
}
unset($codes, $code, $codeval);